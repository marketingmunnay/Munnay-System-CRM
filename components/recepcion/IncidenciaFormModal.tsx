            ...
            <fieldset className="border p-4 rounded-md disabled:opacity-50" disabled={formIsDisabled}>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                    <div>
                        ...
                        <input type="date" id="fecha" name="fecha" value={formatDateForInput(formData.fecha instanceof Date && !isNaN(formData.fecha.getTime()) ? formData.fecha : new Date())} onChange={handleChange} className="w-full border-black bg-[#f9f9fa] rounded-md shadow-sm text-sm p-2 text-black" style={{ colorScheme: 'light' }} />
                    </div>
                    <div>
