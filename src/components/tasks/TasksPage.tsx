...
const demoCards: Record<string, TaskCard[]> = {
  todo: [
    { id: 1, title: 'Crear nueva tarjeta', description: 'Qué tarea se debe realizar', assignee: 'Samantha', tags: [] },
    { id: 2, title: 'Icon en sección nuestros servicios', assignee: 'Samantha', tags: [] },
  ],
  inprogress: [
...
export default function TasksPage() {
  ...
  const [tags, setTags] = useState<Tag[]>([
    { id: 1, title: 'Urgente', color: '#d9534f' },
    { id: 2, title: 'Prioridad Media', color: '#f0ad4e' },
    { id: 3, title: 'Video / Edición', color: '#9b59b6' },
  ]);
                      ...
                      <div className="p-3 bg-white border rounded-md">
                        ...
                        <div className="mb-2">
                          ...
                          <div className="flex flex-col gap-2 text-sm">
                            ...
                            <label className="flex items-center gap-2"><input type="checkbox" checked={addChecklist} onChange={e => setAddChecklist(e.target.checked)} /> Checklist</label>
                            <label className="flex items-center gap-2"><input type="checkbox" checked={addDate} onChange={e => setAddDate(e.target.checked)} /> Fecha</label>
                            ...
                            <label className="flex items-center gap-2"><input type="checkbox" checked={addMembers} onChange={e => setAddMembers(e.target.checked)} /> Miembros</label>
                          </div>
                        </div>
